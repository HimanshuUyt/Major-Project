...
<div class="container">
  <div class="row">
    <form action="{{route('coupon.store')}}" method="POST" enctype="multipart/form-data" class="space-y-5">
      @csrf

      <div class="col-xl">
        <div class="card mt-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Coupon Add Form</h5>
          </div>
          <div class="card-body">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" value="{{ old('c_desc') }}" placeholder="Category Desc" name="c_desc" id="basic-default-fullname" cols="30" rows="3"></textarea>
            </div>
