    ...
    <div class="border border-default-200 rounded-lg bg-white dark:bg-default-50 h-fit">
      ...
      <div class="p-5 border-t border-dashed border-default-200">
        <div class="grid lg:grid-cols-3 gap-6">
          <div class="">
            <form action="{{ route('product.store') }}" method="POST" class="product-dropzone dropzone h-60 mb-6">
              @csrf
              {{ csrf_field() }}
            ...
            <div class="grid grid-cols-2 gap-6">
              <form action="{{ route('product.store') }}" method="POST" class="additional-dropzone dropzone">
                @csrf
                <div class="fallback">
