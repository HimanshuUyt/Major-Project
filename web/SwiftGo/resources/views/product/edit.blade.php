    ...
    <div class="border border-default-200 rounded-lg bg-white dark:bg-default-50 h-fit">
      ...
      <div class="p-5 border-t border-dashed border-default-200">
        <div class="grid lg:grid-cols-3 gap-6">
          <div class="">
            <form action="{{ route('product.update', $product->_id) }}" class="product-dropzone dropzone h-60 mb-6">
              {{ csrf_field() }}

              <div class="fallback">
                <input name="product_mpic" type="file" multiple="multiple">
              </div>
              <div class="dz-message needsclick w-full">
                <div class="mb-3">
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-photo-circle text-primary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 8h.01" /><path d="M4 15l4 -4c.928 -.893 2.072 -.893 3 0l5 5" /><path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l2 2" /><path d="M3 12a9 9 0 0 0 9 9a9 9 0 0 0 9 -9a9 9 0 0 0 -9 -9a9 9 0 0 0 -9 9" /></svg>
                </div>
            ...
            <div class="grid grid-cols-2 gap-6">
              <form action="{{ route('product.update', $product->_id) }}" class="additional-dropzone dropzone">
                @csrf
                <div class="fallback">
                  <input name="product_pic" type="file" multiple="multiple">
                </div>
                <div class="dz-message needsclick w-full">
                  <div class="mb-3">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-photo-circle text-primary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 8h.01" /><path d="M4 15l4 -4c.928 -.893 2.072 -.893 3 0l5 5" /><path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l2 2" /><path d="M3 12a9 9 0 0 0 9 9a9 9 0 0 0 9 -9a9 9 0 0 0 -9 -9a9 9 0 0 0 -9 9" /></svg>
          ...
          <div class="lg:col-span-2">
            <div class="grid lg:grid-cols-2 gap-6 mb-6">
              <div class="space-y-6">
                <div>
                  <input class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Product Name" name="product_name">
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                  <div>
                    <input class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Selling Price" name="product_sp">
                  </div>

                  <div>
                    <input class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="text" placeholder="Cost Price" name="product_cp">
                  </div>
                </div>

                <div>
                  <input class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" type="number" placeholder="Quantity in Stock" name="product_qty">
                </div>
                ...
                <div class="flex justify-between">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <input name="product_expiryDate" type="checkbox" id="addExpiryDate" class="relative w-[3.25rem] h-7 bg-default-200 focus:ring-0 checked:bg-none checked:!bg-primary border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 appearance-none focus:ring-transparent before:inline-block before:w-6 before:h-6 before:bg-white before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:transition before:ease-in-out before:duration-200">
                  </div>
                </div>
                ...
                <div class="flex justify-between">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <input name="returnPolicy" type="checkbox" name="returnPolicy" id="returnPolicy" class="relative w-[3.25rem] h-7 bg-default-200 focus:ring-0 checked:bg-none checked:!bg-primary border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 appearance-none focus:ring-transparent before:inline-block before:w-6 before:h-6 before:bg-white before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:transition before:ease-in-out before:duration-200">
                  </div>
                </div>
              ...
              <div class="space-y-6">
                <div class="relative">
                  <select id="all-select-categories" data-hs-select='{
                    ...
                    <option></option>
                    <option value="admin">Publish</option>
                  ...
                  <div class="grid lg:grid-cols-2 gap-6">
                    <div>
                      <div class="relative">
                        ...
                        <input name="date" type="text" class="block w-full rounded-md py-2.5 px-9 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="datepicker-basic">
                      </div><!-- end relative -->
                    </div>
                    ...
                    <div>
                      <div class="relative">
                        <span class="absolute top-1/2 start-2.5 -translate-y-1/2"><i data-lucide="calendar-days" class="h-4 w-4 text-default-700"></i></span>
                        <span class="absolute top-1/2 end-2.5 -translate-y-1/2"><i data-lucide="chevron-down" class="h-4 w-4 text-default-700"></i></span>
                        <input name="time" type="text" class="block w-full rounded-md py-2.5 px-9 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="timepicker">
                      </div><!-- end relative -->
                    </div>
                  </div>
                </div>
